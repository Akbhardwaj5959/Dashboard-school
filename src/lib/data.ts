...
export const calendarEvents = [
  // 28 Sep 2025
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 8, 28, 8, 0),
    end: new Date(2025, 8, 28, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 8, 28, 9, 0),
    end: new Date(2025, 8, 28, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 8, 28, 10, 0),
    end: new Date(2025, 8, 28, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 8, 28, 11, 0),
  ...
  },
  {
    ...
    end: new Date(2025, 8, 28, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 8, 28, 14, 0),
    end: new Date(2025, 8, 28, 14, 45),
  },
